(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Adecco Group AG, LEI
  NI14Y5UMU60O7JE9P611) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "Adecco Group AG"
   :website    "https://www.adeccogroup.com"})

(def ^:private demo-full-text
  "Terms of Use\nBy accessing this website you agree to these Terms of Use. The content of this site is provided by Adecco Group AG, a global staffing and HR-services group, for informational purposes only and is subject to change without notice. These Terms are governed by the laws of Switzerland.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.adeccogroup.com/terms-of-use"
