# cloud-itonami-lei-ni14y5umu60o7je9p611

> **Independent third-party archive/analysis. Not affiliated with, endorsed by, or sponsored by Adecco Group AG.**

This repository archives the publicly published Terms of Use / Terms and Conditions of
**Adecco Group AG**, with source-url and retrieval-date provenance, per
...
- **LEI (ISO 17442)**: [NI14Y5UMU60O7JE9P611](https://search.gleif.org/#/record/NI14Y5UMU60O7JE9P611) (GLEIF-verified)
- **Jurisdiction**: CH
- **Website**: https://www.adeccogroup.com
- **Ticker**: ADEN (SIX Swiss Exchange)
